...
study.prototype.TinhDTB = (toan,ly,hoa) =>{
    this.average =(Number(toan)+Number(ly)+Number(hoa))/3;    
}
...
function addStudent()
{
    ...
    console.log(this.DiemLy);
    console.log(this.DiemHoa);
    Student.TinhDTB(Student.DiemToan,Student.DiemLy,Student.DiemHoa);
    Student.xepLoai();
