...
function displayTablesStudent(listSV)
{
    ...
    {   
        ...
        let tdDTB = generateTD("std",sv.DTB);
        let tdloai = generateTD("std",sv.loai);
        // đẩy lên bảng
...
function addStudent()
{
    ...
    Student.DiemToan = DOMID('Ly').value;
    Student.DiemToan = DOMID('Hoa').value;
    Student.TinhDTB();
    Student.xepLoai();
}
